...
SCENARIOS = [
    ...
    {
        "name": "abortion_eligible",
        "persona": "You just found out you are pregnant and you want to have an abortion. You are 28 years old. Your last period was about 4 weeks ago. You have public insurance (the yellow card).",
        "patient_name": "Emily Wilson",
        "phone": "66778899",
        "expect_escalation": False,
        "expect": {"condition_id": 5, "insurance_type": "public"},
    },
    {
        "name": "abortion_ineligible",
        "persona": "You found out you are pregnant and you want an abortion. You are 28 years old. Your last period was about 11 weeks ago. You have public insurance.",
        "patient_name": "Sofie Lund",
        "phone": "11445566",
        "expect_escalation": True,
        "expect": {"condition_id": 5},
    },
    {
    ...
    # --- Referral / Insurance Flow ---
    {
        "name": "referral_active_yes",
        "persona": "You have been having urinary leakage problems — you leak urine when you cough or sneeze. This is a new issue and your GP referred you. You have a referral but do NOT mention it unless asked. You have public insurance.",
        "patient_name": "Birgitte Dahl",
        "phone": "33998877",
        "expect_escalation": False,
        "expect": {"condition_id": 31, "doctor": "LB", "has_referral": True, "self_pay": False},
    },
    {
        "name": "no_referral_public_selfpay",
        "persona": "You want to get an IUD (spiral) inserted. You do NOT have a referral from your GP. You have public insurance (the yellow card). You are willing to pay yourself.",
        "patient_name": "Maja Kristensen",
        "phone": "22556644",
        "expect_escalation": False,
        "expect": {"condition_id": 19, "has_referral": False, "self_pay": True, "self_pay_price_dkk": 3500.0},
    },
    {
        "name": "no_referral_dss_escalation",
        "persona": "You want to get an IUD (spiral) inserted. When asked about a referral, you say no, you don't have one. When asked about insurance or the yellow card, you say you have private insurance through Dansk Sundhedssikring (DSS). Only reveal this information when specifically asked — do not volunteer it.",
        "patient_name": "Tina Vestergaard",
        "phone": "77223311",
        "opening": "Hi, I'd like to book an appointment to get a spiral put in.",
        "expect_escalation": True,
        "expect": {"insurance_type": "dss"},
    },
    {
        "name": "abortion_eligible_yellow_card",
        "persona": "You want to have an abortion. You are 25 years old. Your last period was about 3 weeks ago. You have public insurance (the yellow card). Do NOT mention insurance unless asked.",
        "patient_name": "Camilla Bak",
        "phone": "88991122",
        "expect_escalation": False,
        "expect": {"condition_id": 5, "insurance_type": "public"},
    },
